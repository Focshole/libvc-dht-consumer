...
find_path(
  ...
  PATHS ${LibVersioningCompilerCons_INSTALL_PATH}/include
        ${LibVersioningCompilerCons_SOURCE_PATH}/include /usr/local/include
...
if(LibVersioningCompilerCons_INCLUDE_DIRS-NOTFOUND)
  ...
  endif(LibVersioningCompilerCons_FIND_REQUIRED)
...
find_library(
  ...
  PATHS ${LibVersioningCompilerCons_INSTALL_PATH}/lib
        ${LibVersioningCompilerCons_BINARY_PATH} /usr/local/lib /usr/lib /lib
...
get_filename_component(LibVersioningCompilerCons_LIBRARY_DIR
                       ${LibVersioningCompilerCons_LIBRARY} PATH)

set(LibVersioningCompilerCons_LIBRARIES ${LibVersioningCompilerCons_LIBRARY}
                                        ${UUID_LIBRARY} ${CMAKE_DL_LIBS})

# Check for libVersioningCompiler
find_package(LibVersioningCompiler REQUIRED)
set(LibVersioningCompilerCons_INCLUDE_DIRS
    "${LibVersioningCompilerCons_INCLUDE_DIRS}" "${LIBVC_INCLUDE_DIRS}")
set(LibVersioningCompilerCons_LIBRARIES "${LibVersioningCompilerCons_LIBRARIES}"
                                        "${LIBVC_LIBRARIES}")
set(LibVersioningCompilerCons_LIBRARY_DIR
    ${LibVersioningCompilerCons_LIBRARY_DIR} ${LIBVC_LIB_DIR})
...
set(LibVersioningCompilerCons_INCLUDE_DIRS
    "${LibVersioningCompilerCons_INCLUDE_DIRS}" "${GNUTLS_INCLUDE_DIR}")
set(LibVersioningCompilerCons_LIBRARIES "${LibVersioningCompilerCons_LIBRARIES}"
                                        "${GNUTLS_LIBRARIES}")
...
set(LibVersioningCompilerCons_INCLUDE_DIRS
    "${LibVersioningCompilerCons_INCLUDE_DIRS}" "${LIBZMQ_INCLUDE_DIRS}")
set(LibVersioningCompilerCons_LIBRARIES "${LibVersioningCompilerCons_LIBRARIES}"
                                        "${LIBZMQ_LIBRARIES}")
set(LibVersioningCompilerCons_LIBRARIES ${LibVersioningCompilerCons_LIBRARIES}
                                        "-lzmq")
...
if(LibVersioningCompilerCons_FOUND)
  set(LibVersioningCompilerCons_INCLUDES
      ${LibVersioningCompilerCons_INCLUDE_DIRS})
  set(LibVersioningCompilerCons_LIBS ${LibVersioningCompilerCons_LIBRARIES})
  set(LibVersioningCompilerCons_LIB_DIR
      ${LibVersioningCompilerCons_LIBRARY_DIR})
